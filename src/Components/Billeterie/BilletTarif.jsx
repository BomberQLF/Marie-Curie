const BilletTarif = ({ ticketName, price, counter, increment, decrement }) => {
  return (
    <div>
      <div className="p-4 flex flex-col gap-2 lg:gap-12 w-fit border border-white border-solid rounded-[22px] mb-4 md:flex-row md:gap-36 lg:gap-48">
        <div className="w-[13rem]">
          <p className="text-white text-sm md:text-xl">{ticketName}</p>
